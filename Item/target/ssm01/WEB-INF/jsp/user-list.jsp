...
<nav class="breadcrumb"> <a href="/index.jsp">首页</a> <span class="c-gray en">&gt;</span> 用户管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form id="sform" name="sform" action="/user/search">
<div class="pd-20">
  <input type="hidden" id="pageNum" name="pageNum" value="${pageInfo.pageNum}">
  <div class="text-c">
    <input type="text" class="input-text" style="width:550px" placeholder="输入用户名称关键字" id="name" name="name" value="${name}"><button type="submit" class="btn btn-success" id="" name=""> 搜用户</button>

  </div>
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    <%--<span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="icon-trash"></i> 批量删除</a>
    --%><a href="/user-add.jsp" onclick="user_add('550','','添加用户','/user-add.jsp')" class="btn btn-primary radius"><i class="icon-plus"></i> 添加用户</a></span>
      ...
      <tr class="text-c">
       <%-- <td><input type="checkbox" value="1" name=""></td>--%>
        ...
        <td><a style="text-decoration: none" class="ml-5" onClick=""
               href="update?id=${user.userId}" title="编辑">编辑

        </a> <a style="text-decoration: none" class="ml-5"
                href="delete?id=${user.userId}" title="删除">删除 </a></td>
      </tr>
    </c:forEach>
    </tbody>
